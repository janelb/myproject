...
<div class="wrapper" id="app">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
                    ...
                    <table class="table">
                        <tr>
                            ...
                            <td style="width: 280px">
                                <input type="text" disabled id="carLisence" name="licenceNo" class="form-control" v-model="car.licenceNo"/>
                            </td>
                            <td >
            ...
            <button class="btn btn-info btn-block btn-lg" @click="newOrder">跟新订单</button>
    ...
    $(function () {
        ...
        var vm = new Vue({
            ...
            mounted:function(){
                ...
                /*进行回显*/
                $.get("/order/"+orderId+"/info").done(function (response) {
                    vm.car = response.data.order.car;
                    vm.customer = response.data.order.customer;
                    vm.serviceType = response.data.serviceType;
                    vm.choosePartsList = response.data.partsList;
