        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="/typeedit" method="post" class="form-horizontal" id="updateForm">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">节点名称:</label>
                            <div class="col-sm-10">
                                <input type="hidden" class="form-control" name="updateid"  id="updateNode" placeholder="请输入节点名称">
                                <input type="text" class="form-control" name="addName"  id="updateNodeName" placeholder="请输入节点名称">
                            </div>
                        </div>
                    </form>
